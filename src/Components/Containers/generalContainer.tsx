...
export default function GeneralContainer() {
  const { currentPosts, loading, error, nextPage, prevPage, currentPage, FilteredObjects, postPerPage, Filters, SearchBar } = useUserContext()
  ...
  return (
    <div>
      ...
      {Filters.subsection === "all" && Filters.type === "all" && SearchBar === ""  && (
