            ...
            <section className="flex items-center py-10 bg-gray-100 font-poppins">
                <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-6 md:px-6">
                    <div className="flex flex-wrap items-center">
                        <div className="w-full px-2 mb-10 xl:w-1/2 lg:mb-8">
                            <div className="flex flex-wrap">
                                <div className="w-full px-4 md:w-1/2 items-center justify-center ">
                                    <img src="/oldlogo.png" alt="1924"
                                        className=" mb-6 rounded-lg h-80 " />
                                        <p className="text-xs -mt-4">Año: 1923</p>
                                    <img src="/oldlogo3.png" alt=""
                                        className="w-full rounded-lg h-80 py-20" />
                                         <p className="text-xs -mt-16">Año: 1995</p>
                                </div>
                                <div className="w-full px-4 md:w-1/2 xl:mt-11">
                                    <img src="/oldlogo2.png"alt=""
                                        className="w-full mb-6 rounded-lg h-80 py-20" />
                                         <p className="text-xs -mt-24 mb-32">Año: 1963</p>
                                    <img src="/logoactual.png" alt=""
                                        className="object-fill w-full rounded-lg h-80 py-20" />
                                         <p className="text-xs -mt-14">Año: 2020</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
                            <span className="text-sm font-semibold text-blue-500 dark:text-blue-400">¿Porque elegirnos?</span>
                            <h2 className="mt-2 mb-4 text-2xl font-bold text-gray-700 ">
                                Somos Casa Tomas: 100 Años de Pasión por la Costura

                            </h2>
                            <p className="mb-4 text-xs leading-7 text-gray-500 dark:text-gray-400">
