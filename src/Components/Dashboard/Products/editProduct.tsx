...
const EditProduct: React.FC<EditProductProps> = ({ handleModal, _id }) => {
  ...
  function convertObjectTypeToNewProductState(
    object: ObjectType
  ): NewProductState {
    return {
      offer: object.offer,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-h-[95vh] max-w-[160vh] p-6 relative ">
        <button
          onClick={() => {
                          ...
                          <div className="px-2 py-0 text-gray-900 font-bold">
                            ...
                            <div className="py-2 px-2 rounded-lg">
                              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                                {updateProduct.data.items[0].models.map(
                                  (model, index) => (
                                    <div
                                      key={index}
                              ...
                              <button
                                ...
                                onClick={() =>
                                  addModel(
                                    `Modelo ${
                                      updateProduct.data.items[0].models
                                        .length + 1
                                    }`
                                  )
                                }
                      ...
                      return (
                        <div className="flex items-center space-x-4">
                          <ColorPicker
                            ...
                            colors={colors}
                            currentColors={updateProduct.data.items[0].colours}
                          />
                        ...
                        <div className="flex space-x-4">
                          ...
                          <button
                            onClick={(e) => {
                              ...
                              addModel(
                                `Modelo ${
                                  updateProduct.data.items[0].models.length + 1
                                }`
                              );
                            }}
